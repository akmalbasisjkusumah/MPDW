...
selisihdesopt<-ramalandesopt$mean-testing$`Harga_Beras`
selisihdesopt

SSEtestingdesopt<-sum(selisihdesopt^2)
MSEtestingdesopt<-SSEtestingdesopt/length(testing$`Harga_Beras`)
MAPEtestingdesopt<-sum(abs(selisihdesopt/testing$`Harga_Beras`)*100)/length(testing$`Harga_Beras`)
