...
```{r}
datakurs <- rio::import("https://raw.githubusercontent.com/rizkynurhambali/Praktikum-MPDW-2324/main/Pertemuan%2067/kurs.csv",header=T)
...
```{r}
index <- seq(1:430)
bc = MASS::boxcox(train.ts~index, lambda = seq(5,8,by=1))
...
model terbaik
diagnostik sisaan
jika terlanggar tangani
overfitting
jika model overfitting lebih baik dipakai
diagnostik sisaan
